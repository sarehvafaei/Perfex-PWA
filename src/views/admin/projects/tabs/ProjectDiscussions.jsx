...
//import { getProjectDiscussions } from "api/projects";

export default function ProjectDiscussions({ projectId }) {
  const [milestones, setDiscussions] = useState([]);
  ...
  const load = async () => {
    ...
    try {
      ...
      setDiscussions(data.milestones || []);
    } catch (err) {
      ...
      <div className="">
        <table className="w-full text-sm">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-4 py-2 text-left border border-gray-200">Discussion</th>
